...
export const features: SiteFeature[] = [
  ...
  },
  {
    ...
    description: "QA dashboard with live test counts from this repo and illustrative demo coverage.",
    group: "Lab",
    status: "live",
  },
  {
  ...
  },
  {
    ...
    description: "Live test counts for this repository plus an illustrative enterprise-style metrics demo.",
    group: "Lab",
    status: "live",
  },
  {
